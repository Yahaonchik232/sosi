...
const SilnoShumit = (props) => {
  return (
    <>
      <div className="page-container10">
        <Head>
          <title>Стиральная машина сильно шумит - что делать?</title>
          <meta property="og:title" content="Стиральная машина сильно шумит - что делать?" />
        </Head>
        <Header />
          ...
          <div className="page-left-main-box">
            <div className="page-headertextwashermachine">
              <h1 className="page-text10">
                <span className="page-text11">
                  Стиральная машина силь��о шумит —
                </span>
            ...
            <div className="page-container12">
              <h2 className="zagolovki2">
                Здесь будет размещен контент о проблеме с шумом стиральной машины
              </h2>
