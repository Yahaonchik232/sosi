...
const NeslivaetivOdu = (props) => {
  return (
    <>
      <div className="page-container10">
        <Head>
          <title>Стиральная машина не сливает воду - что делать?</title>
          <meta property="og:title" content="Стиральная машина не сливает воду - что делать?" />
        </Head>
        <Header />
          ...
          <div className="page-left-main-box">
            ...
            <div className="page-container12">
              <h2 className="zagolovki2">
                Здесь будет размещен контент о проблеме со сливом воды в стиральной машине
              </h2>
