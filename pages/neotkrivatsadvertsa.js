...
const NeOtkrivatSaDvertsa = (props) => {
  return (
    <>
      <div className="page-container10">
        <Head>
          <title>Стиральная машина не открывается дверца - что делать?</title>
          <meta property="og:title" content="Стиральная машина не открывается дверца - что делать?" />
        </Head>
        <Header />
          ...
          <div className="page-left-main-box">
            <div className="page-headertextwashermachine">
              <h1 className="page-text10">
                <span className="page-text11">
                  Стиральная машина не открывается дверца —
                </span>
            ...
            <div className="page-container12">
              <h2 className="zagolovki2">
                Здесь будет размещен контент о проблеме с открытием дверцы стиральной машины
              </h2>
...
export default NeOtkrivatSaDvertsa
