...
const Protekaet = (props) => {
  return (
    <>
      <div className="page-container10">
        <Head>
          <title>Стиральная машина протекает - что делать?</title>
          <meta property="og:title" content="Стиральная машина протекает - что делать?" />
        </Head>
        <Header />
          ...
          <div className="page-left-main-box">
            ...
            <div className="page-container12">
              <h2 className="zagolovki2">
                Здесь будет размещен контент о проблеме протечек в стиральной машине
              </h2>
