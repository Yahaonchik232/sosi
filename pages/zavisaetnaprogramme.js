...
const ZavisaetNaProgramme = (props) => {
  return (
    <>
      <div className="page-container10">
        <Head>
          <title>Стиральная машина зависает на программе - что делать?</title>
          <meta property="og:title" content="Стиральная машина зависает на программе - что делать?" />
        </Head>
        <Header />
          ...
          <div className="page-left-main-box">
            ...
            <div className="page-container12">
              <h2 className="zagolovki2">
                Здесь будет размещен контент о проблеме зависания стиральной машины на программе
              </h2>
...
export default ZavisaetNaProgramme
