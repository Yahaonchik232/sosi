              ...
              <div className="page-container13">
                ...
                <p className="vicetext page-text18">
                  ...
                  <span className="page-text22">
                    2. Перерасп��еделите или уберите часть белья.
                  </span>
                  <span>
                    {' '}
                  ...
                  <span>
                    {' '}
                    Попробуйте покр��тить барабан рукой (после слива воды барабан
            ...
            <section id="3" className="page-thirdproblem2">
              ...
              <div className="page-container20">
                ...
                <p className="vicetext">
                  ...
                  ремень; при этом машина может выполнять другие этапы цик��а
            ...
            <section id="4" className="page-fiveproblem1">
              ...
              <div className="page-container23">
                ...
                <p className="page-text46 vicetext">
                  ...
                  не ��апускается; иногда слышен только гул мотора без движения
